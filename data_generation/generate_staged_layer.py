...
def harmonise_windchill(row: dict, dq_flags: list) -> dict:
    ...
    return {
        ...
        "revision":               revision,
        "title":                  f"{discipline} -- {row['wc_document_type']} -- {source_native_id}",
...
def harmonise_sharepoint(row: dict, dq_flags: list) -> dict:
    ...
    return {
        ...
        "discipline":             discipline,
        "revision":               revision,
        "title":                  f"{discipline} -- {row['sp_document_category']} -- SP-{source_native_id}",
...
def harmonise_aveva(row: dict, dq_flags: list) -> dict:
    ...
    return {
        ...
        "discipline":             discipline,
        "revision":               revision,
        "title":                  f"{discipline} -- {row['aveva_doc_type']} -- {source_native_id}",
